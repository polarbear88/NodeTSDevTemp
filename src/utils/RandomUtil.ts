/*
 * @Author: polarbear
 * @Date: 2022-02-26 15:05:24
 * @LastEditTime: 2022-02-26 15:08:46
 * @LastEditors: polarbear
 * @Description: 
 * @FilePath: /NodeTSDevTemp/src/utils/RandomUtil.ts
 */
...
export default class RandomUtil {
    ...
    public static getMacAddr(): string {
        return `${RandomUtil.getHexString(2)}:${RandomUtil.getHexString(2)}:${RandomUtil.getHexString(2)}:${RandomUtil.getHexString(2)}:${RandomUtil.getHexString(2)}:${RandomUtil.getHexString(2)}`.toLowerCase();
    }
